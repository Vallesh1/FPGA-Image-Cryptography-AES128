...
HD_PWD='C:/Users/esaik/aes/aes.runs/aes_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_axi_dma_0_0.tcl
