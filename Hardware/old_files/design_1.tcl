...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net AES_En_De_0_output_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins AES_En_De_0/output_stream]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AES_En_De_0/input_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins AES_En_De_0/s_axi_control]
  ...
  [get_bd_pins AES_En_De_0/ap_clk]
  ...
  [get_bd_pins AES_En_De_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AES_En_De_0/s_axi_control/Reg] -force
